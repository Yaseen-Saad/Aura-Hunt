...
async function seedDatabase() {
  try {
    ...
    // Use questions-updated.json which includes deduction values
    const questionsData = JSON.parse(fs.readFileSync(path.join(__dirname, '../data/questions-updated.json'), 'utf8'));
